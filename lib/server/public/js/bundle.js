...
/***/ function(module, exports, __webpack_require__) {
	...
	var _griddleReact = __webpack_require__(149);

	var _griddleReact2 = _interopRequireDefault(_griddleReact);

	var _fixturesGrid = __webpack_require__(176);

	/* jshint ignore:start */
	_reactDom2['default'].render(_react2['default'].createElement(_griddleReact2['default'], { results: _fixturesGrid.fakeData, resultsPerPage: 20 }), document.getElementById('griddle'));
	/* jshint ignore:end */
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var GridTable = __webpack_require__(162);
	var GridFilter = __webpack_require__(168);
	var GridPagination = __webpack_require__(169);
	var GridSettings = __webpack_require__(170);
	var GridNoData = __webpack_require__(171);
	var GridRow = __webpack_require__(172);
	var CustomRowComponentContainer = __webpack_require__(174);
	var CustomPaginationContainer = __webpack_require__(175);
	var ColumnProperties = __webpack_require__(165);
	var RowProperties = __webpack_require__(167);
	var deep = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var React = __webpack_require__(150);
	var GridTitle = __webpack_require__(163);
	    ...
	    if (that.state.showChildren) {
	      children = that.props.hasChildren && this.props.data.children.map(function (row, index) {
	        if (typeof row.children !== "undefined") {
	          var Griddle = __webpack_require__(149);
	          return React.createElement(
	            "tr",
	            { style: { paddingLeft: 5 } },
	            React.createElement(
